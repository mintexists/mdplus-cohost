...
var require_renderer = __commonJS({
  "node_modules/markdown-it/lib/renderer.js"(exports, module) {
    ...
    Renderer.prototype.renderInline = function(tokens, options, env) {
      ...
      for (var i = 0, len2 = tokens.length; i < len2; i++) {
        type = tokens[i].type;
    ...
    Renderer.prototype.render = function(tokens, options, env) {
      var i, len2, type, result = "", rules = this.rules;
      for (i = 0, len2 = tokens.length; i < len2; i++) {
        type = tokens[i].type;
        if (type === "inline") {
...
var require_token = __commonJS({
  "node_modules/markdown-it/lib/token.js"(exports, module) {
    ...
    Token.prototype.attrIndex = function attrIndex(name) {
      ...
      attrs = this.attrs;
      for (i = 0, len2 = attrs.length; i < len2; i++) {
        if (attrs[i][0] === name) {
          return i;
        }
      }
...
var require_fence = __commonJS({
  "node_modules/markdown-it/lib/rules_block/fence.js"(exports, module) {
    ...
    module.exports = function fence(state, startLine, endLine, silent) {
      var marker, len2, params, nextLine, mem, token, markup, haveEndMarker = false, pos = state.bMarks[startLine] + state.tShift[startLine], max = state.eMarks[startLine];
      if (state.sCount[startLine] - state.blkIndent >= 4) {
        return false;
      }
      if (pos + 3 > max) {
...
var require_state_block = __commonJS({
  "node_modules/markdown-it/lib/rules_block/state_block.js"(exports, module) {
    ...
    function StateBlock(src, md2, env, tokens) {
      var ch, s, start, pos, len2, indent, offset, indent_found;
      this.src = src;
      this.md = md2;
      this.env = env;
      this.tokens = tokens;
      ...
      s = this.src;
      indent_found = false;
      for (start = pos = indent = offset = 0, len2 = s.length; pos < len2; pos++) {
        ch = s.charCodeAt(pos);
        if (!indent_found) {
          if (isSpace(ch)) {
            indent++;
...
var require_parser_block = __commonJS({
  "node_modules/markdown-it/lib/parser_block.js"(exports, module) {
    ...
    ParserBlock.prototype.tokenize = function(state, startLine, endLine) {
      var ok, i, rules = this.ruler.getRules(""), len2 = rules.length, line = startLine, hasEmptyLines = false, maxNesting = state.md.options.maxNesting;
      while (line < endLine) {
...
var require_strikethrough = __commonJS({
  "node_modules/markdown-it/lib/rules_inline/strikethrough.js"(exports, module) {
    ...
    module.exports.tokenize = function strikethrough(state, silent) {
      var i, scanned, token, len2, ch, start = state.pos, marker = state.src.charCodeAt(start);
      if (silent) {
        return false;
      }
      if (marker !== 126) {
...
var require_parser_inline = __commonJS({
  "node_modules/markdown-it/lib/parser_inline.js"(exports, module) {
    ...
    ParserInline.prototype.skipToken = function(state) {
      var ok, i, pos = state.pos, rules = this.ruler.getRules(""), len2 = rules.length, maxNesting = state.md.options.maxNesting, cache = state.cache;
    ...
    ParserInline.prototype.tokenize = function(state) {
      var ok, i, rules = this.ruler.getRules(""), len2 = rules.length, end = state.posMax, maxNesting = state.md.options.maxNesting;
      while (state.pos < end) {
        if (state.level < maxNesting) {
          for (i = 0; i < len2; i++) {
...
var require_linkify_it = __commonJS({
  "node_modules/linkify-it/index.js"(exports, module) {
    ...
    LinkifyIt.prototype.test = function test(text) {
      ...
      var m, ml, me, len2, shift, next, re, tld_pos, at_pos;
      if (this.re.schema_test.test(text)) {
        re = this.re.schema_search;
        re.lastIndex = 0;
        while ((m = re.exec(text)) !== null) {
          len2 = this.testSchemaAt(text, m[2], re.lastIndex);
          if (len2) {
            this.__schema__ = m[2];
    ...
    LinkifyIt.prototype.matchAtStart = function matchAtStart(text) {
      ...
      if (!m)
        return null;
      var len2 = this.testSchemaAt(text, m[2], m[0].length);
      if (!len2)
        return null;
      this.__schema__ = m[2];
      this.__index__ = m.index + m[1].length;
...
// node_modules/markdown-it-plain-text/index.js
var require_markdown_it_plain_text = __commonJS({
  "node_modules/markdown-it-plain-text/index.js"(exports, module) {
    "use strict";
    module.exports = function plainTextPlugin(md2) {
      function plainTextRule(state) {
        var text = scan(state.tokens);
        md2.plainText = text.replace(/\s+/g, " ");
      }
      function scan(tokens) {
        ...
        for (var i = 0; i < tokens.length; i++) {
          ...
          if (token.children !== null) {
            ...
            if (token.type === "text" || token.type === "fence" || token.type === "html_block" || token.type === "code_block" || token.type === "code_inline" || token.type === "html_inline" || token.type === "emoji") {
              text += token.content;
      ...
      md2.core.ruler.push("plainText", plainTextRule);
    };
  }
});
...
var require_route = __commonJS({
  "node_modules/color-convert/route.js"(exports, module) {
    ...
    function buildGraph() {
      ...
      for (let len2 = models.length, i = 0; i < len2; i++) {
        graph[models[i]] = {
          distance: -1,
          parent: null
        };
...
var import_markdown_it_plain_text = __toESM(require_markdown_it_plain_text());
...
md.use(import_markdown_it_plain_text.default);
...
function getWidthEm(text) {
  ...
  const widthEm = width / parseInt(getCssStyle(app, "font-size").replace("px", ""));
  return widthEm;
}
...
function validateColor(c) {
  try {
    let parsed = (0, import_color.default)(c);
    return true;
  } catch (err) {
    return false;
  }
...
function createEscapedMap(text) {
  ...
  const isEscaped = (i, accum = 0) => {
    if (chars[i - 1] === "/")
      return [!isEscaped(i - 1), accum + 1];
    return [false, accum];
  };
  for (let i = chars.length - 1; i >= 0; i--) {
    let [escaped2, removeChars] = isEscaped(i);
    if (escaped2) {
      escaped2[i] = true;
      i -= removeChars;
      escaped2.splice(i - removeChars, removeChars);
...
function parse(text, addPlaintext = true, inline = false) {
  ...
  const setStyle = (index, style) => {
    if (style === null || charStyleMap[index] === null)
      return charStyleMap[index] = null;
  ...
  const replaceStyle = (regex, start, end, style) => {
    ...
    let match2;
    while ((match2 = r.exec(text)) !== null) {
      const unicodeOffset = match2[0].length - len(match2[0]);
      const startContent = r.lastIndex - match2[0].length + start;
      const endContent = r.lastIndex - end - unicodeOffset;
      let mayOverrideShit = false;
      for (let i = r.lastIndex - match2[0].length; i < startContent; i++) {
        if (charStyleMap[i] === null)
          mayOverrideShit = true;
        setStyle(i, null);
      }
      ...
      for (let i = startContent; i < endContent; i++) {
        const res = style(match2[1], i - startContent);
        if (res[0]) {
  ...
  while ((match = colorRegex.exec(text)) !== null) {
    if (match[1].startsWith("/"))
      continue;
    if (match[1] !== "rainbow" && match[1] !== "<rainbow>" && !allMatch(match[1].replace(/^<(.+)>$/, "$1").split(":"), validateColor))
      continue;
    ...
    while ((endMatch = colorRegex2.exec(text.slice(startSearch))) !== null) {
      if (!endMatch[1].startsWith("/"))
        continue;
      if (endMatch[1] !== "rainbow" && match[1] !== "<rainbow>" && endMatch[1] !== "/" && !allMatch(endMatch[1].slice(1).replace(/^<(.+)>$/, "$1").split(":"), validateColor))
        continue;
      if (endMatch[1] === "/" || endMatch[1].slice(1) === match[1]) {
        ...
        let colors;
        if (col === "rainbow") {
          colors = Array(32).fill(0).map((_, i) => import_color.default.hsl(i / 32 * 360, 80, 50));
        } else {
          colors = col.split(":").map((s) => (0, import_color.default)(s));
        }
        ...
        for (let i = matchStart; i < startSearch; i++)
          setStyle(i, null);
        for (let i = endContent; i < end; i++)
          setStyle(i, null);
        for (let i = startSearch; i < endContent; i++) {
          if (colors.length > 1) {
            ...
            const smoothedColor = import_color.default.rgb(
  ...
  let processedText = toChars(text).map((l, i) => {
    ...
    if (map === null) {
      ...
      if (stringifiedStyle !== oldStyle) {
        if (map && map.filter((m) => m && m.display === "inline-block").length > 0 && t === " ")
          t = "&nbsp;";
        ...
        if (oldUnclosed)
          for (let i2 = 0; i2 < oldOpenSpans; i2++)
            t = "</span>" + t;
      }
  ...
  processedText = processedText.replace(
    /\|\|(.+?)\|\|/ug,
    (_, v) => `<details style="background-color:#000;cursor:pointer;display:inline-block;position:relative;height:1.4em"><summary style="color:rgba(0,0,0,0);display:flex" aria-hidden="true">${v}</summary><span style="position:absolute;inset:0;pointer-events:none;background-color:#111;color:#fff">${v}</span></details>`
  );
